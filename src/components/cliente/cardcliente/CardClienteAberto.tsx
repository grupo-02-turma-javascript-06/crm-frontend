                ...
                <div className="flex flex-col justify-between items-center bg-white p-8 min-w-[90%] md:min-h-112 md:min-w-171 rounded-2xl">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 w-full items-center md:mt-10">
                        ...
                        <div className="flex flex-col mt-5">
                            ...
                            <p className="text-gray-600 text-lg pt-4">{cliente.email}</p>
                            <p className="text-gray-600 text-lg pt-2">{cliente.telefone}</p>
                            <p className="text-gray-600 text-lg pt-2">{cliente.data_inscricao}</p>
                            <p className="text-gray-600 text-lg pt-2">{cliente.historico}</p>
                        </div>
                    </div>
